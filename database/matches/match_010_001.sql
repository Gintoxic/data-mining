...
prep as
(select import_counter, origin_iata, dest_iata, airline_iata as airline_iata, flightnumber, 
to_timestamp(dep_sche_local,'DD.MM.YYYY hh24:min')::timestamp without time zone as dep_sched_local 
from cd_010_01
),
--select * from prep
valid_rows as
