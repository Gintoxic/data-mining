...
from  cd_017_01
where dep_sched_local_day != '[no data]' and dep_sched_local_time is not null
)
--select * from prep1
,

prep2 as
(select import_counter, origin_iata, dest_iata, airline_iata as airline_iata, flightnumber_op as flightnumber, 
to_timestamp(dep_sched_local_day||' '||dep_sched_local_time,'DD.MM.YYYY HH24:MI')::timestamp without time zone as dep_sched_local 
from prep1
),
--select * from prep2
