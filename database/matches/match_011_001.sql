...
prep as
(select import_counter, seg_dep_loc_code as origin_iata, seg_dest_loc_code as dest_iata, airline_iata as airline_iata, flighnumber as flightnumber, 
to_timestamp(seg_dep_date,'DD.MM.YYYY')::timestamp without time zone as dep_sched_local 
from cd_011_01
),
--select * from prep
