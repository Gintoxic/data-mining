...
prep2 as
(select import_counter, origin_airport_code as origin_iata, destination_airport_code as dest_iata, flown_airline_code as airline_iata, flight_number as flightnumber, 
