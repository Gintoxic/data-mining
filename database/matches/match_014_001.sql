...
prep1 as
(
select *, trim(substr(coupon_airport_pair, 1,3)) as origin_iata , 
trim(substr(coupon_airport_pair, 5)) as dest_iata, trim(substr(flight_number, 1,2)) as airline_iata, 
substr(flight_number, 4) as flightnumber
