...
from staging.c_bayer_test c
 )
 select row_number() over (partition by 1 order by ticketnummer, abreisedatum, ankunftsdatum, origin_iata, dest_iata), 
airline_iata,
airline_name,
flightnumber,
origin_iata,
